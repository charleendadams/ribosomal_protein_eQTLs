---
title: "Obtaining the effect allele frequencies (EAFs) for Gene-Tissue Expression (GTEx) ribosomal protein (RP) expression quantitative trait loci (eQTL)"
date: "April 26, 2020"
#runtime: shiny
...
summary(merged$EAF)
```
# Provide an interactive table of the primary ribosomal protein eQTL data (selected variables, including EAF)
