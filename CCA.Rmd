---
title: "Canonical Correlation Analysis (CCA) to correct tissue-by-RP-gene matrix"
...
$cor(X,Y)$ is a $2\times 2$ matrix, where:    
\[
...
The interpretation of the coefficients is similar to that of multiple regression. They are the values of the correlations when holding all the other variables constant; i.e., for the $X$ set, they are the relationship between tissue pairs when accounting for latent structure from donor sample imbalances.
```{r, include=FALSE}
can_cor1[3:4]
...
## Sources 
 ...
 [*Link*](http://www.karlin.mff.cuni.cz/~maciak/NMST539/cvicenie11.html) for the code for intra and inter correlations of matrices.
 
 [*Another*](https://stats.idre.ucla.edu/r/dae/canonical-correlation-analysis/) helpful link to read up on CCA. 
 
## Github
I've started a [*Github*](https://github.com/charleendadams/ribosomal_protein_eQTLs) repository to organize the files and scripts for this project. 
